...
2. In your new project, click the **web icon (`</>`)** on the project
...
6. In the left sidebar, click **Build → Authentication → Get started**.
   On the "Sign-in method" tab, enable **Email/Password** (click it, toggle
   "Enable", click "Save"). This is what powers the login screen.
7. Still on Authentication, click the **Users** tab, then **Add user** for
